...
* Saturday **May 8, at 23h**: submit the SMTP lab results
  * You work in pairs
...
* **Tuesday, April 27 and Tuesday, May 4**, the videos for these sessions are on the HTTP playlist and Docker playlist (see Week 8 and Week 9 below). A lot of video content was produced last year to introduce 2 key topics: HTTP and Docker. You will consume this content during these sessions and make sure that you do the exercise yourselves.
